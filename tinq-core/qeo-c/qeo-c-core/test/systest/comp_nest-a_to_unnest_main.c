...
// population values for inner struct
static int _inner_int8_value = 222;
static int _inner_int32_value = 2222222222;
static char* _inner_string_value = "content of _inner_string_value";
static int _inner_int16_value = 22222;
static int64_t _inner_int64_value = INT64_C(2222222222222222222);
...
static qeocore_type_t *type_nest_a_register(qeo_factory_t *factory)
{
    qeocore_type_t *outer = NULL;
...
{
    // writer is a type_nest_a writer
    qeo_factory_t *factory;
    qeocore_type_t *type_nest_a;
    ...
    assert(NULL != (type_nest_a = type_nest_a_register(factory)));
    assert(NULL != (writer = qeocore_writer_open(factory, type_nest_a, NULL,
...
static void run_reader(void)
{
    ...
    assert(NULL != (reader = qeocore_reader_open(factory, type_unnest, NULL,
                                                 QEOCORE_EFLAG_STATE_DATA | QEOCORE_EFLAG_ENABLE,
                                                 &listener, NULL)));
