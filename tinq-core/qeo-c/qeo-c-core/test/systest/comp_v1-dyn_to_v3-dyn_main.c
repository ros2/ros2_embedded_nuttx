...
static qeocore_member_id_t _int32_3_id = QEOCORE_MEMBER_ID_DEFAULT;
static qeocore_member_id_t _int8_3_id = QEOCORE_MEMBER_ID_DEFAULT;
static qeocore_member_id_t _string_3_id = QEOCORE_MEMBER_ID_DEFAULT;

static void my_on_data_available(const qeocore_reader_t *reader,
                                 const qeocore_data_t *data,
                                 uintptr_t userdata)
{
    // the reader is a type3 reader
    switch (qeocore_data_get_status(data)) {
        case QEOCORE_DATA: {

            int int32_value_rx=0, int8_value_rx=0;
            int int32_3_value_rx=0, int8_3_value_rx=0 ;
            char* string_value_rx="";
            char* string_3_value_rx="";
            ...
            assert(QEO_OK == qeocore_data_get_member(data, _int32_3_id, &int32_3_value_rx));
            assert(QEO_OK == qeocore_data_get_member(data, _int8_3_id, &int8_3_value_rx));
            assert(QEO_OK == qeocore_data_get_member(data, _string_3_id, &string_3_value_rx));
            log_verbose(" =================== int32_value_rx = %u \n", int32_value_rx );
            log_verbose(" =================== int8_value_rx = %u \n", int8_value_rx );
            log_verbose(" =================== string_value_rx = \"%s\" \n", string_value_rx );
            log_verbose(" =================== int32_3_value_rx = %u \n", int32_3_value_rx );
            log_verbose(" =================== int8_3_value_rx = %u \n", int8_3_value_rx );
            log_verbose(" =================== string_3_value_rx = \"%s\" \n", string_3_value_rx );
...
static qeocore_type_t *type3_register(qeo_factory_t *factory)
{
    qeocore_type_t *dyndata = NULL;
    qeocore_type_t *primitive = NULL;
    ...
    qeocore_type_free(primitive);
    assert(NULL != (primitive = qeocore_type_primitive_new(QEOCORE_TYPECODE_INT32)));
    assert(QEO_OK == qeocore_type_struct_add(dyndata, primitive, "int32_3", &_int32_3_id, QEOCORE_FLAG_NONE));
    qeocore_type_free(primitive);
    assert(NULL != (primitive = qeocore_type_primitive_new(QEOCORE_TYPECODE_INT8)));
    assert(QEO_OK == qeocore_type_struct_add(dyndata, primitive, "int8", &_int8_id, QEOCORE_FLAG_NONE));
    qeocore_type_free(primitive);
    assert(NULL != (primitive = qeocore_type_primitive_new(QEOCORE_TYPECODE_INT8)));
    assert(QEO_OK == qeocore_type_struct_add(dyndata, primitive, "int8_3", &_int8_3_id, QEOCORE_FLAG_NONE));
    qeocore_type_free(primitive);
    assert(NULL != (primitive = qeocore_type_string_new(0)));
    assert(QEO_OK == qeocore_type_struct_add(dyndata, primitive, "string", &_string_id, QEOCORE_FLAG_NONE));
    qeocore_type_free(primitive);
    assert(NULL != (primitive = qeocore_type_string_new(0)));
    assert(QEO_OK == qeocore_type_struct_add(dyndata, primitive, "string_3", &_string_3_id, QEOCORE_FLAG_NONE));
    qeocore_type_free(primitive);
...
static void run_writer(pid_t peer)
{
    ...
    assert(NULL != (writer = qeocore_writer_open(factory, type1, NULL,
...
static void run_reader(void)
{
    ...
    assert(NULL != (factory = qeocore_factory_new(QEO_IDENTITY_DEFAULT)));
    init_factory(factory);
    assert(NULL != (type3 = type3_register(factory)));
    assert(NULL != (reader = qeocore_reader_open(factory, type3, NULL,
                                                 QEOCORE_EFLAG_STATE_DATA | QEOCORE_EFLAG_ENABLE,
                                                 &listener, NULL)));
