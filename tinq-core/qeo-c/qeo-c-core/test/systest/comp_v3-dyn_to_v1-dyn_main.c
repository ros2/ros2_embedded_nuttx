...
// population values for version 3
static int _int8_3_value = 333;
static int _int32_3_value = 3333333333;
static char* _string_3_value = "content of _string_3_value";
...
static void run_writer(pid_t peer)
{
    ...
    assert(NULL != (writer = qeocore_writer_open(factory, type3, NULL,
    ...
    assert(QEO_OK == qeocore_data_set_member(data, _int32_3_id, &_int32_3_value));
    assert(QEO_OK == qeocore_data_set_member(data, _int8_3_id, &_int8_3_value));
    assert(QEO_OK == qeocore_data_set_member(data, _string_3_id, &_string_3_value));
    /* write */
