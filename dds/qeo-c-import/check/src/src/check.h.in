...
// macro without side-effects
#define __ck_assert_int(X, O, Y, c) { long _x__5D911DBC_E5DC_4503_8ED6_12B3024D837F=(long)(X);  \
                                      long _y__5D911DBC_E5DC_4503_8ED6_12B3024D837F=(long)(Y);  \
                                      ck_assert_msg(_x__5D911DBC_E5DC_4503_8ED6_12B3024D837F O _y__5D911DBC_E5DC_4503_8ED6_12B3024D837F, \
                                           "'"#X#O#Y"' failed, expected:%s%d, actual:%d", c, _y__5D911DBC_E5DC_4503_8ED6_12B3024D837F, _x__5D911DBC_E5DC_4503_8ED6_12B3024D837F);}

#define ck_assert_int_eq(X, Y) __ck_assert_int(X, ==, Y, "" )
#define ck_assert_int_ne(X, Y) __ck_assert_int(X, !=, Y, "different from ")
#define ck_assert_int_lt(X, Y) __ck_assert_int(X, <, Y, "less than ")
#define ck_assert_int_gt(X, Y) __ck_assert_int(X, >, Y, "greater than ")
#define ck_assert_int_lteq(X, Y) __ck_assert_int(X, <=, Y, "less than or equal ")
#define ck_assert_int_gteq(X, Y) __ck_assert_int(X, >=, Y, "greater than or equal ")
...
// macro without side-effects
#define __ck_assert_str(C, X, O, Y, c) { const char* _xstr__5D911DBC_E5DC_4503_8ED6_12B3024D837F=(const char*)(X);  \
                                         const char* _ystr__5D911DBC_E5DC_4503_8ED6_12B3024D837F=(const char*)(Y);  \
                                         ck_assert_msg(C, "'"#X#O#Y"' failed, expected:%s'%s', actual:'%s'", c, _ystr__5D911DBC_E5DC_4503_8ED6_12B3024D837F, _xstr__5D911DBC_E5DC_4503_8ED6_12B3024D837F);}


#define ck_assert_str_eq(X, Y) __ck_assert_str(!strcmp(X, Y), X, ==, Y, "")
#define ck_assert_str_ne(X, Y) __ck_assert_str(strcmp(X, Y), X, !=, Y, "different from ")
