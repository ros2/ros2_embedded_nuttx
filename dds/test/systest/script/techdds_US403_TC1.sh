...
echo "[US 403 - TC 1][DDS][techdds_main] script start"
logger [US 403 - TC 1][DDS][techdds_main] script start
...
echo "[US 403 - TC 1][DDS][techdds_main] script stop"
logger [US 403 - TC 1][DDS][techdds_main] script stop
exit 0
